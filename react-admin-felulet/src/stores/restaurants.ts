export const restaurants = [
  { id: 1, name: 'Király Bisztró', description: 'Finom és friss ételek várnak minden látogatót!', image: 'src/assets/pizza-margherita.jpg', meals: [
  ...
  {id:2,  name: 'Pizza Mester', description: 'A legjobb pizzák a városban, friss alapanyagokból!', image: 'src/assets/hamburger.jpg', meals: [
  ...
  {id:3, name: 'Sushi Szamuráj', description: 'Autentikus japán sushi, amit imádni fogsz!', image: 'src/assets/caesar-salad.jpg', meals: [

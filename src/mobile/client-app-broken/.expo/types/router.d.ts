...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/+not-found` | `/adminToggleButton` | `/authStore` | `/base_layout` | `/cartIconButton` | `/cartScreen` | `/cartStore` | `/checkoutScreen` | `/constant_colors` | `/contact` | `/debugDashboard` | `/homeScreen` | `/loginScreen` | `/mealsScreen` | `/mealsStore.csv` | `/modal` | `/models/meal` | `/models/orderItem` | `/models/user` | `/orders` | `/payingScreen` | `/placeholder.jpg` | `/profileIconButton` | `/profileScreen` | `/profileStore` | `/registerScreen` | `/useMeals` | `/_layout`;
  // prettier-ignore
